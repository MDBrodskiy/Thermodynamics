  ...
  \item
    ...
    \begin{enumerate}
      ...
      \item 
        ...
        $$\boxed{\left(10^{24}\right)\left( 10^{-164,345} \right)=10^{-164,316}[\text{probability of Hamlet in given time}]}$$
  ...
  \item
    ...
    \begin{enumerate}
      ...
      \item
        ...
        We can rearrange this formula to write:

        $$\frac{g_1(N_1,\hat{s}_1+\delta)g_2(N_2,\hat{s}_1-\delta)}{(g_1,g_2)_{max}}=e^{-\left( \frac{2\delta^2}{N_1}+\frac{2\delta^2}{N_2} \right)}$$

        Thus, we find that:

        $$\frac{g_1g_2}{(g_1,g_2)_{max}}=e^{-\left( \frac{4(10^{11})^2}{10^{22} \right)}\Rightarrow$$
          $$\boxed{\frac{g_1g_2}{(g_1,g_2)_{max}}=e^{-4}\approx .01832}$$

      \item 

        From the problem above, we know:
